...
class UserStatsModel(models.Model):
    ...
    ka = models.FloatField(default=0)
    kka = models.FloatField(default=0)
    gha = models.FloatField(default=0)
    ggha = models.FloatField(default=0)
    nga = models.FloatField(default=0)
    cha = models.FloatField(default=0)
    ccha = models.FloatField(default=0)
    ja = models.FloatField(default=0)
    jja = models.FloatField(default=0)
    nnja = models.FloatField(default=0)
    ta = models.FloatField(default=0)
    tta = models.FloatField(default=0)
    da = models.FloatField(default=0)
    dda = models.FloatField(default=0)
    nna = models.FloatField(default=0)
    tha = models.FloatField(default=0)
    ttha = models.FloatField(default=0)
    dha = models.FloatField(default=0)
    ddha = models.FloatField(default=0)
